...
class OPort:
    ...
    def get_info_from_ip(self, host, port):
        self.open_ports.append(socket.getaddrinfo(host, port)[0])
    ...
    def scan(self, host, port):
        try:
            ...
            self.get_info_from_ip(host, port)
...
if __name__ == '__main__':
    ...
    if (len(ports) > 1):
        ...
        if (len(o.open_ports)):
            ...
            for oport in o.open_ports:
                family, type, proto, sockaddr, canonname = oport
